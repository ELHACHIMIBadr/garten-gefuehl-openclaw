...
def validate_seo_title(title: str, keyword: str) -> List[str]:
    """
...
def validate_meta_description(meta: str, keyword: str) -> List[str]:
...
def validate_content(html_content: str, keyword: str, min_words: int = 1500) -> List[str]:
